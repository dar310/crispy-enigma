...
export class BaseHttpService {
  ...
  public findById(id: number | string): Observable<any> {
    return this.http.get<any>(`${this.apiServerUrl}${this.path}/${id}`);
  }
  ...
  // ✅ Added partial update (PATCH)
  public patch(id: number, updates: any): Observable<any> {
    return this.http.patch<any>(`${this.apiServerUrl + this.path}/${id}`, updates);
  }

  public delete(id: number): Observable<any> {
    return this.http.delete<any>(`${this.apiServerUrl + this.path}/${id}`);
  }
}
